...
class MarkerClusterNode {
  ...
  MarkerNode nearestMarkerNode = null;
  ...
  LatLng get point {
    if (nearestMarkerNode != null) {
      return nearestMarkerNode.marker.point;
    }
    nearestMarkerNode = getNearestMarker();
    return nearestMarkerNode.marker.point;
  }

  MarkerNode getNearestMarker() {
